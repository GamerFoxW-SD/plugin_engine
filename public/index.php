...
// A plugin csak akkor működik, ha explicit aktiváljuk.
...
$title = htmlspecialchars($render->getTitle() ?? 'Plugin Engine', ENT_QUOTES, 'UTF-8');
?>
<!doctype html>
<html lang="hu">
<head>
...
<main>
    <?php foreach ($render->sections() as $section): ?>
        <?= $section ?>
    <?php endforeach; ?>
    <div class="engine-footer">Rendered by Engine + independent plugins</div>
</main>
